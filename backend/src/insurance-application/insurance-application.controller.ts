...
export class InsuranceApplicationController {
  ...
  create(@Body() createInsuranceApplicationDto: CreateInsuranceApplicationDto) {
    return this.insuranceApplicationService.create(createInsuranceApplicationDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateInsuranceApplicationDto: UpdateInsuranceApplicationDto) {
    return this.insuranceApplicationService.update(+id, updateInsuranceApplicationDto);
  }
